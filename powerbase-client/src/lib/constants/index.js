...
export const DB_PLATFORMS = [
  {
    name: 'Powerbase Cloud',
    description: 'A free cloud platform powered by Powerbase.',
    price: '$0',
  },
...
export const POWERBASE_TYPE = [
  {
    ...
    description:
      'Get a faster experience with the power of Elastic Search. Great for dealing with large datasets.',
  },
  {
    name: 'Regular',
    description: 'A normal experience suited for dealing with small datasets.',
  },
];
