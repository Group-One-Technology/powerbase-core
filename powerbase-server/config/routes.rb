...
Rails.application.routes.draw do
  ...
  put '/forgot_password/', to: 'users/passwords#forgot'
  put '/reset_password/', to: 'users/passwords#reset'
  ...
  resources :powerbase_databases, as: "databases", path: "databases", except: [:update], shallow: true do
    collection do
      post 'connect'
    ...
    resources :powerbase_tables, path: 'tables', as: 'tables', shallow: true do
      resources :powerbase_fields, path: 'fields', as: 'fields', except: [:show], shallow: true do
        member do
