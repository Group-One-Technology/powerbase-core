...
class Powerbase::Notifier
  ...
  def event_trigger_sql(table_name)
    "
  ...
  def add_event_trigger(table_name)
    ...
    begin
      ...
      sequel_connect(powerbase_database) do |db|
        db.run(event_trigger_sql(table_name))
      end
  ...
  def drop_event_trigger_sql(table_name)
    "
  ...
  def add_drop_event_trigger(table_name)
    ...
    begin
      ...
      sequel_connect(powerbase_database) do |db|
        db.run(drop_event_trigger_sql(table_name))
      end
