module PermissionsHelper
  ...
  TABLE_PERMISSIONS = [:view_table, :manage_table, :add_views, :manage_views, :delete_views, :add_fields, :delete_fields, :add_records, :delete_records, :comment_records]
  FIELD_PERMISSIONS = [:view_field, :manage_field, :edit_field_data]
  VIEW_PERMISSIONS = [:manage_view]
  ...
  ROLES = {
    ...
    :editor => [:view_base, *VIEW_PERMISSIONS, :add_views, :manage_views, :view_table, :view_field, :add_records, :delete_records, :comment_records],
